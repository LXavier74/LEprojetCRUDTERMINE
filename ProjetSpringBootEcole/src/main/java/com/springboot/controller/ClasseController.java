...
public class ClasseController {
	...
	private Classe convertForm(ClasseForm classeform) throws Exception {
		...
		Professeur prof = serviceprof.rechercheProfId(Integer.valueOf(classeform.getProf()));
	...
	public String ajoutClasse(@Valid @ModelAttribute(name = "classeform") ClasseForm classeform, BindingResult presult,
			Model pmodel) {
	...
	public String modifieClasse(@Valid @ModelAttribute(name = "classeform") ClasseForm classeform,
